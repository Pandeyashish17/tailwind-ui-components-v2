...
<template>
  <div class="bg-white">
        ...
        <div class="flex items-center justify-between py-6 md:justify-start md:space-x-10">
          <div class="flex justify-start lg:w-0 lg:flex-1">
            <a href="#">
              ...
              <img class="h-8 w-auto sm:h-10" src="https://tailwindui.com/img/logos/mark.svg?color=blue&shade=600" alt="" />
            </a>
          </div>
          ...
          <PopoverGroup as="nav" class="hidden space-x-10 md:flex">
            ...
            <Popover class="relative" v-slot="{ open }">
              ...
              <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0 translate-y-1" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition ease-in duration-150" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-1">
                <PopoverPanel class="absolute left-1/2 mt-3 w-screen max-w-md -translate-x-1/2 transform px-2 sm:px-0">
                  <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                    <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
          ...
          <div class="hidden items-center justify-end space-x-8 md:flex md:flex-1 lg:w-0">
            ...
            <a href="#" class="inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-blue-100 py-2 px-4 text-base font-medium text-blue-700 hover:bg-blue-200">Sign up</a>
          </div>
        </div>
      </div>
    ...
    <div class="bg-gradient-to-b from-blue-50 via-white to-white">
      ...
      <div class="mx-auto max-w-7xl py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div class="pb-16 xl:flex xl:items-center xl:justify-between">
          ...
          <a href="#" class="mt-8 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-blue-600 py-3 px-5 text-base font-medium text-white hover:bg-blue-700 sm:mt-10 sm:w-auto xl:mt-0">Get started today</a>
        </div>
        <div class="border-t border-gray-200 pt-16 xl:grid xl:grid-cols-3 xl:gap-x-8">
          <div>
            <h2 class="text-lg font-semibold text-blue-600">Everything you need</h2>
          ...
          <div class="mt-4 sm:mt-8 md:mt-10 md:grid md:grid-cols-2 md:gap-x-8 xl:col-span-2 xl:mt-0">
            <ul role="list" class="divide-y divide-gray-200">
              <li v-for="(feature, featureIdx) in features.slice(0, 5)" :key="feature" :class="[featureIdx === 0 ? 'md:py-0 md:pb-4' : '', 'py-4 flex']">
            ...
            <ul role="list" class="divide-y divide-gray-200 border-t border-gray-200 md:border-t-0">
              <li v-for="(feature, featureIdx) in features.slice(5)" :key="feature" :class="[featureIdx === 0 ? 'md:border-t-0 md:py-0 md:pb-4' : '', 'py-4 flex']">
                <CheckIcon class="h-6 w-6 flex-shrink-0 text-green-500" aria-hidden="true" />
                <span class="ml-3 text-base text-gray-500">{{ feature }}</span>
              </li>
            </ul>
        ...
        <div class="mt-6 border-t border-blue-400 border-opacity-25 pt-10">
          <dl class="space-y-10 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-x-8 md:gap-y-12 md:space-y-0">
            <div v-for="item in faqs" :key="item.id">
              <dt class="text-lg font-medium leading-6 text-white">{{ item.question }}</dt>
              <dd class="mt-2 text-base text-blue-200">{{ item.answer }}</dd>
            </div>
          </dl>
        </div>
      </div>
      ...
      <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-24 lg:px-8">
        ...
        <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
          <div class="inline-flex rounded-md shadow">
            <a href="#" class="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 py-3 px-5 text-base font-medium text-white hover:bg-blue-700">Get started</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Simple footer -->
    <footer class="mx-auto max-w-7xl overflow-hidden py-16 px-4 sm:px-6 lg:px-8">
      <nav class="-mx-5 -my-2 flex flex-wrap justify-center">
        <div v-for="item in footerNavigation.main" :key="item.name" class="py-2 px-5">
      ...
      <p class="mt-8 text-center text-base text-gray-500">&copy; 2020 Your Company, Inc. All rights reserved.</p>
    </footer>
  </div>
</template>
