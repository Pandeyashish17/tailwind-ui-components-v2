...
<template>
  <div class="bg-white">
    <div class="bg-indigo-900">
      ...
      <Popover class="relative">
        <div class="mx-auto max-w-7xl px-4 sm:px-6">
          <div class="flex items-center justify-between border-b border-indigo-400 border-opacity-25 py-6 md:justify-start md:space-x-10">
            <div class="flex justify-start lg:w-0 lg:flex-1">
              <a href="#">
                <span class="sr-only">Your Company</span>
                <img class="h-8 w-auto sm:h-10" src="https://tailwindui.com/img/logos/mark.svg?from-color=orange&from-shade=400&to-color=pink&to-shade=500&toShade=500" alt="" />
              </a>
            </div>
            <div class="-my-2 -mr-2 md:hidden">
              <PopoverButton class="inline-flex items-center justify-center rounded-md bg-indigo-900 p-2 text-indigo-300 hover:bg-indigo-800 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
            ...
            <PopoverGroup as="nav" class="hidden space-x-10 md:flex">
              <Popover class="relative" v-slot="{ open }">
                <PopoverButton :class="[open ? 'text-white' : 'text-indigo-300', 'group inline-flex items-center rounded-md bg-indigo-900 text-base font-medium hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-900']">
                  <span>Solutions</span>
            ...
            <div class="hidden items-center justify-end space-x-8 md:flex md:flex-1 lg:w-0">
              ...
              <a href="#" class="inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-white py-2 px-4 text-base font-medium text-indigo-600 shadow-sm hover:bg-indigo-50">Sign up</a>
            </div>
          </div>
        </div>
            ...
            <div class="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
              <div class="space-y-6 px-5 pt-5 pb-6">
                <div class="flex items-center justify-between">
                  <div>
                    <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?from-color=orange&from-shade=400&to-color=pink&to-shade=500&toShade=500" alt="Your Company" />
                  </div>
                  <div class="-mr-2">
        ...
        <div class="px-0 sm:px-4 lg:flex lg:items-center lg:justify-between lg:px-0">
          ...
          <div class="mt-10 w-full max-w-xs lg:mt-0">
            ...
            <div class="relative mt-1.5">
              <select id="currency" name="currency" class="block w-full rounded-md border border-transparent bg-indigo-400 bg-opacity-25 bg-none text-white focus:border-white focus:ring-white">
      ...
      <div class="space-y-24 lg:hidden">
        <section v-for="tier in tiers" :key="tier.name">
          <div class="mb-8 px-4">
            ...
            <a :href="tier.href" class="mt-6 block w-full rounded-md border border-transparent bg-gradient-to-r from-orange-500 to-pink-500 py-2 text-center text-sm font-semibold text-white shadow hover:to-pink-600">Buy {{ tier.name }}</a>
          </div>
          ...
          <table v-for="section in sections" :key="section.name" class="w-full">
            ...
            <tbody class="divide-y divide-gray-200">
              <tr v-for="feature in section.features" :key="feature.name" class="border-t border-gray-200">
                <th class="py-5 px-4 text-left text-sm font-normal text-gray-500" scope="row">{{ feature.name }}</th>
                <td class="py-5 pr-4">
          ...
          <div class="border-t border-gray-200 px-4 pt-5">
            <a href="#" class="block w-full rounded-md border border-transparent bg-gradient-to-r from-orange-500 to-pink-500 py-2 text-center text-sm font-semibold text-white shadow hover:to-pink-600">Buy {{ tier.name }}</a>
          </div>
        </section>
      </div>
      ...
      <div class="hidden lg:block">
        <table class="h-px w-full table-fixed">
          ...
          <tbody class="divide-y divide-gray-200 border-t border-gray-200">
            <tr>
              <th class="py-8 pl-6 pr-6 text-left align-top text-sm font-medium text-gray-900" scope="row">Pricing</th>
            ...
            <template v-for="section in sections" :key="section.name">
              ...
              <tr v-for="feature in section.features" :key="feature.name">
                <th class="py-5 pl-6 pr-6 text-left text-sm font-normal text-gray-500" scope="row">{{ feature.name }}</th>
    ...
    <!-- Logo cloud -->
    <div class="mx-auto max-w-7xl border-t border-gray-200 py-12 px-4 sm:px-6 lg:py-20 lg:px-8">
    ...
    <div class="relative">
      ...
      <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="overflow-hidden rounded-lg bg-gradient-to-r from-orange-400 to-pink-500 shadow-xl lg:grid lg:grid-cols-2 lg:gap-4">
          <div class="px-6 pt-10 pb-12 sm:px-16 sm:pt-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
            <div class="lg:self-center">
              ...
              <a href="#" class="mt-8 inline-flex items-center rounded-md border border-transparent bg-orange-100 py-3 px-6 text-base font-medium text-red-600 shadow hover:text-red-500">Sign up for free</a>
            </div>
          </div>
    ...
    <!-- Footer -->
    <footer class="mx-auto mt-12 max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
      <h2 class="sr-only">Footer</h2>
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <div class="grid grid-cols-2 gap-8 xl:col-span-2">
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div>
              <h4 class="text-base font-medium text-gray-900">Solutions</h4>
              <ul role="list" class="mt-4 space-y-4">
            ...
            <div class="mt-12 md:mt-0">
              <h4 class="text-base font-medium text-gray-900">Support</h4>
              <ul role="list" class="mt-4 space-y-4">
          ...
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div>
              <h4 class="text-base font-medium text-gray-900">Company</h4>
              <ul role="list" class="mt-4 space-y-4">
            ...
            <div class="mt-12 md:mt-0">
              <h4 class="text-base font-medium text-gray-900">Legal</h4>
              <ul role="list" class="mt-4 space-y-4">
        ...
        <div class="mt-8 xl:mt-0">
          <h4 class="text-base font-medium text-gray-900">Subscribe to our newsletter</h4>
          ...
          <form class="mt-4 sm:flex sm:max-w-md">
            ...
            <input type="email" name="email-address" id="email-address" autocomplete="email" required="" class="w-full min-w-0 rounded-md border-gray-300 bg-white py-2 px-4 placeholder-gray-500 shadow-sm focus:border-orange-500 focus:outline-none focus:ring-orange-500" placeholder="Enter your email" />
...
import { CheckIcon, ChevronDownIcon, MinusIcon } from '@heroicons/vue/20/solid'
