  ...
  <div class="bg-white">
    <header class="relative bg-blue-gray-800 pb-36">
      <div class="absolute inset-0">
        ...
        <div class="absolute inset-0 bg-blue-gray-800 mix-blend-multiply" aria-hidden="true" />
      </div>
      <Popover as="div" class="relative z-10">
        <nav class="relative mx-auto flex max-w-7xl items-center justify-between px-4 pt-6 pb-2 sm:px-6 lg:px-8" aria-label="Global">
          <div class="flex flex-1 items-center">
            <div class="flex w-full items-center justify-between lg:w-auto">
              <a href="#">
                <span class="sr-only">Your Company</span>
                <img class="h-8 w-auto sm:h-10" src="https://tailwindui.com/img/logos/mark.svg?color=blue&shade=500" alt="" />
              </a>
              <div class="-mr-2 flex items-center lg:hidden">
                <PopoverButton class="focus-ring-inset inline-flex items-center justify-center rounded-md bg-blue-gray-900 bg-opacity-0 p-2 text-white hover:bg-opacity-100 focus:outline-none focus:ring-2 focus:ring-white">
            ...
            <div class="hidden space-x-10 lg:ml-10 lg:flex">
              <a v-for="item in navigation" :key="item.name" :href="item.href" class="text-base font-medium text-white hover:text-blue-100">{{ item.name }}</a>
            </div>
          </div>
          <div class="hidden lg:flex lg:items-center lg:space-x-6">
            <a href="#" class="rounded-md border border-transparent bg-blue-500 py-2 px-6 text-base font-medium text-white shadow-md hover:bg-blue-600">Login</a>
          </div>
        </nav>
          ...
          <PopoverPanel focus class="absolute inset-x-0 top-0 origin-top transform p-2 transition lg:hidden">
            <div class="overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
              <div class="flex items-center justify-between px-5 pt-4">
                ...
                <div class="-mr-2">
                  <PopoverButton class="inline-flex items-center justify-center rounded-md bg-white p-2 text-blue-gray-400 hover:bg-blue-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500">
              ...
              <div class="pt-5 pb-6">
                <div class="space-y-1 px-2">
                  <a v-for="item in navigation" :key="item.name" :href="item.href" class="block rounded-md px-3 py-2 text-base font-medium text-blue-gray-900 hover:bg-blue-gray-50">{{ item.name }}</a>
                </div>
                <div class="mt-6 px-5">
                  <a href="#" class="block w-full rounded-md border border-transparent bg-blue-500 py-2 px-4 text-center font-medium text-white shadow hover:bg-blue-600">Login</a>
                </div>
              </div>
            </div>
          </PopoverPanel>
      ...
      <div class="relative mx-auto mt-24 max-w-md px-4 pb-32 sm:max-w-3xl sm:px-6 md:mt-32 lg:max-w-7xl lg:px-8">
        ...
        <p class="mt-6 max-w-3xl text-xl text-blue-gray-300">Varius facilisi mauris sed sit. Non sed et duis dui leo, vulputate id malesuada non. Cras aliquet purus dui laoreet diam sed lacus, fames. Dui, amet, nec sit pulvinar.</p>
      </div>
    </header>
    ...
    <main>
      <div class="bg-blue-gray-50">
        <!-- Cards -->
        <section class="relative z-10 mx-auto -mt-32 max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8" aria-labelledby="contact-heading">
          <h2 class="sr-only" id="contact-heading">Contact us</h2>
          <div class="grid grid-cols-1 gap-y-20 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-8">
            <div v-for="link in supportLinks" :key="link.name" class="flex flex-col rounded-2xl bg-white shadow-xl">
              <div class="relative flex-1 px-6 pt-16 pb-8 md:px-8">
                <div class="absolute top-0 inline-block -translate-y-1/2 transform rounded-xl bg-blue-600 p-5 shadow-lg">
              ...
              <div class="rounded-bl-2xl rounded-br-2xl bg-blue-gray-50 p-6 md:px-8">
                <a :href="link.href" class="text-base font-medium text-blue-700 hover:text-blue-600">
                  Contact us
      ...
      <section class="relative bg-white" aria-labelledby="join-heading">
        <div class="absolute inset-x-0 hidden h-1/2 bg-blue-gray-50 lg:block" aria-hidden="true" />
        <div class="mx-auto max-w-7xl bg-blue-600 lg:bg-transparent lg:px-8">
          <div class="lg:grid lg:grid-cols-12">
            ...
            <div class="relative bg-blue-600 lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">
              ...
              <div class="relative mx-auto max-w-md space-y-6 py-12 px-4 sm:max-w-3xl sm:py-16 sm:px-6 lg:col-span-6 lg:col-start-4 lg:max-w-none lg:p-0">
                ...
                <a class="block w-full rounded-md border border-transparent bg-white py-3 px-5 text-center text-base font-medium text-blue-700 shadow-md hover:bg-blue-gray-50 sm:inline-block sm:w-auto" href="#">Explore open positions</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- Newsletter Section -->
      <section class="mx-auto max-w-md py-24 px-4 sm:max-w-3xl sm:px-6 lg:flex lg:max-w-7xl lg:items-center lg:py-32 lg:px-8" aria-labelledby="newsletter-heading">
        <div class="lg:w-0 lg:flex-1">
          <h2 class="text-3xl font-bold tracking-tight text-blue-gray-900 sm:text-4xl" id="newsletter-heading">Sign up for our newsletter</h2>
    ...
    <footer class="bg-blue-gray-50" aria-labelledby="footer-heading">
      <h2 id="footer-heading" class="sr-only">Footer</h2>
      <div class="mx-auto max-w-md py-12 px-4 sm:max-w-7xl sm:px-6 lg:py-16 lg:px-8">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          <div class="space-y-8 xl:col-span-1">
            <img class="h-10" src="https://tailwindui.com/img/logos/mark.svg?color=blueGray&shade=300" alt="Company name" />
            <p class="text-base text-blue-gray-500">Making the world a better place through constructing elegant hierarchies.</p>
            <div class="flex space-x-6">
              <a v-for="item in footerNavigation.social" :key="item.name" :href="item.href" class="text-blue-gray-400 hover:text-blue-gray-500">
          ...
          <div class="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 class="text-base font-medium text-blue-gray-900">Solutions</h3>
                <ul role="list" class="mt-4 space-y-4">
                  <li v-for="item in footerNavigation.solutions" :key="item.name">
                    <a :href="item.href" class="text-base text-blue-gray-500 hover:text-blue-gray-900">{{ item.name }}</a>
                  </li>
                </ul>
              </div>
              <div class="mt-12 md:mt-0">
                <h3 class="text-base font-medium text-blue-gray-900">Support</h3>
                <ul role="list" class="mt-4 space-y-4">
            ...
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 class="text-base font-medium text-blue-gray-900">Company</h3>
                <ul role="list" class="mt-4 space-y-4">
              ...
              <div class="mt-12 md:mt-0">
                <h3 class="text-base font-medium text-blue-gray-900">Legal</h3>
                <ul role="list" class="mt-4 space-y-4">
        ...
        <div class="mt-12 border-t border-blue-gray-200 pt-8">
          <p class="text-base text-blue-gray-400 xl:text-center">&copy; 2020 Your Company, Inc. All rights reserved.</p>
        </div>
      </div>
    </footer>
  </div>
