        ...
        <DisclosurePanel>
          ...
          <dl class="mt-10 space-y-6 text-sm font-medium text-gray-500">
            ...
            <div class="flex justify-between">
              <dt class="flex">
                Discount
                <span class="ml-2 rounded-full bg-gray-200 py-0.5 px-2 text-xs tracking-wide text-gray-600">{{ discount.code }}</span>
              </dt>
    ...
    <section aria-labelledby="payment-heading" class="flex-auto overflow-y-auto px-4 pt-12 pb-16 sm:px-6 sm:pt-16 lg:px-8 lg:pt-0 lg:pb-24">
      <div class="mx-auto max-w-lg">
        ...
        <form class="mt-6">
          ...
          <button type="submit" class="mt-6 w-full rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Pay {{ total }}</button>
