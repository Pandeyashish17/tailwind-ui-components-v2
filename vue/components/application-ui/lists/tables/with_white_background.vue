          ...
          <table class="min-w-full divide-y divide-gray-300">
            ...
            <tbody class="divide-y divide-gray-200">
              <tr v-for="person in people" :key="person.email">
                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6 md:pl-0">{{ person.name }}</td>
                <td class="whitespace-nowrap py-4 px-3 text-sm text-gray-500">{{ person.title }}</td>
                <td class="whitespace-nowrap py-4 px-3 text-sm text-gray-500">{{ person.email }}</td>
                <td class="whitespace-nowrap py-4 px-3 text-sm text-gray-500">{{ person.role }}</td>
