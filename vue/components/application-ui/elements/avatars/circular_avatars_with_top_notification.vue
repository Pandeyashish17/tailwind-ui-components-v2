...
<template>
  <span class="relative inline-block">
    ...
    <span class="absolute top-0 right-0 block h-1.5 w-1.5 rounded-full bg-gray-300 ring-2 ring-white" />
  </span>
  ...
  <span class="relative inline-block">
    ...
    <span class="absolute top-0 right-0 block h-2.5 w-2.5 rounded-full bg-green-400 ring-2 ring-white" />
  </span>

  <span class="relative inline-block">
    <img class="h-12 w-12 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
    <span class="absolute top-0 right-0 block h-3 w-3 rounded-full bg-gray-300 ring-2 ring-white" />
  </span>
  ...
  <span class="relative inline-block">
    ...
    <span class="absolute top-0 right-0 block h-3.5 w-3.5 rounded-full bg-red-400 ring-2 ring-white" />
  </span>
  ...
  <span class="relative inline-block">
    ...
    <span class="absolute top-0 right-0 block h-4 w-4 rounded-full bg-green-400 ring-2 ring-white" />
  </span>
</template>
