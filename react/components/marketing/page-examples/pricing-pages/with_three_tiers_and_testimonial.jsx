                          ...
                          <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                            <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                              {header.solutions.map((solution) => (
                                ...
                                >
                                  <solution.icon className="h-6 w-6 flex-shrink-0 text-rose-400" aria-hidden="true" />
                                  <div className="ml-4">
                            ...
                            <div className="space-y-6 bg-gray-50 px-5 py-5 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8">
                              {header.callsToAction.map((cta) => (
                                <div key={cta.name} className="flow-root">
                                  ...
                                  >
                                    <cta.icon className="h-6 w-6 flex-shrink-0 text-gray-400" aria-hidden="true" />
                            ...
                            <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                              {header.resources.map((resource) => (
                                <a
                                  ...
                                  className="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50"
                                >
                                  <resource.icon className="h-6 w-6 flex-shrink-0 text-rose-400" aria-hidden="true" />
                                  <div className="ml-4">
                  ...
                  <ul role="list" className="mt-6 space-y-6">
                    {tier.features.map((feature) => (
                      <li key={feature} className="flex">
                        <CheckIcon className="h-6 w-6 flex-shrink-0 text-rose-500" aria-hidden="true" />
